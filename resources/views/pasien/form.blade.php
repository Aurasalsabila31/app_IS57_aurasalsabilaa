...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item active">Form Tambah Pasien</li>
            </ol>
        </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="card-body table-responsive p-0">
            <form class="form-horizontal" action="/pasien/store" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" name="jenis">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Jenis Kelamin</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPassword3" name="jenis_kelamin">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  ...
                  <a href="/pasien" class="btn btn-default float-right">Batal</a>
                </div>
                <!-- /.card-footer -->
              </form>        
        </div>
